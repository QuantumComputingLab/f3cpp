...
void test_f3c_turnover() {
  ...
  //
  {
    ...
    vee.push_back( std::make_unique< XY >( gate1 ) ) ;
    vee.push_back( std::make_unique< XY >( gate2 ) ) ;
    vee.push_back( std::make_unique< XY >( gate3 ) ) ;

    qclab::QCircuit< T >  hat( 3 ) ;
    hat.push_back( std::make_unique< XY >( gateA ) ) ;
    hat.push_back( std::make_unique< XY >( gateB ) ) ;
    hat.push_back( std::make_unique< XY >( gateC ) ) ;

    EXPECT_NEAR( qclab::nrmF( vee , hat ) , 0.0 , 10*eps ) ;
  }

  {
    XY gate1( 0 , 1 , 0.1 , 0.6 ) ;
    XY gate2( 1 , 2 , 0.2 , 0.7 ) ;
    XY gate3( 0 , 1 , 0.3 , 0.8 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 1 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 2 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 0 ) ;
  ...
  //
  {
    ...
    qclab::QCircuit< T >  hat( 3 ) ;
    hat.push_back( std::make_unique< XY >( gate1 ) ) ;
    hat.push_back( std::make_unique< XY >( gate2 ) ) ;
    hat.push_back( std::make_unique< XY >( gate3 ) ) ;

    qclab::QCircuit< T >  vee( 3 ) ;
    vee.push_back( std::make_unique< XY >( gateA ) ) ;
    vee.push_back( std::make_unique< XY >( gateB ) ) ;
    vee.push_back( std::make_unique< XY >( gateC ) ) ;

    EXPECT_NEAR( qclab::nrmF( hat , vee ) , 0.0 , 10*eps ) ;
  }

  {
    XY gate1( 1 , 2 , 0.1 , 0.6 ) ;
    XY gate2( 0 , 1 , 0.2 , 0.7 ) ;
    XY gate3( 1 , 2 , 0.3 , 0.8 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 0 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 1 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 1 ) ;
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% //
  ...
  //
  {
    TFXY gate1( 0 , 1 , 1 , 1 , 0 , 0 ) ;
    TFXY gate2( 1 , 2 , 1 , 1 , 0 , 0 ) ;
    TFXY gate3( 0 , 1 , 1 , 1 , 0 , 0 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 1 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 2 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 0 ) ;
    ...
    qclab::QCircuit< T >  vee( 3 ) ;
    vee.push_back( std::make_unique< TFXY >( gate1 ) ) ;
    vee.push_back( std::make_unique< TFXY >( gate2 ) ) ;
    vee.push_back( std::make_unique< TFXY >( gate3 ) ) ;

    qclab::QCircuit< T >  hat( 3 ) ;
    hat.push_back( std::make_unique< TFXY >( gateA ) ) ;
    hat.push_back( std::make_unique< TFXY >( gateB ) ) ;
    hat.push_back( std::make_unique< TFXY >( gateC ) ) ;
...

  {
    ...
    TFXY gate1( 0 , 1 , a1 , b1 , c1 , d1 ) ;
    TFXY gate2( 1 , 2 , a2 , b2 , c2 , d2 ) ;
    TFXY gate3( 0 , 1 , a3 , b3 , c3 , d3 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 1 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 2 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 0 ) ;
  ...
  //
  {
    TFXY gate1( 1 , 2 , 1 , 1 , 0 , 0 ) ;
    TFXY gate2( 0 , 1 , 1 , 1 , 0 , 0 ) ;
    TFXY gate3( 1 , 2 , 1 , 1 , 0 , 0 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 0 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 1 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 1 ) ;
    ...
    qclab::QCircuit< T >  hat( 3 ) ;
    hat.push_back( std::make_unique< TFXY >( gate1 ) ) ;
    hat.push_back( std::make_unique< TFXY >( gate2 ) ) ;
    hat.push_back( std::make_unique< TFXY >( gate3 ) ) ;

    qclab::QCircuit< T >  vee( 3 ) ;
    vee.push_back( std::make_unique< TFXY >( gateA ) ) ;
    vee.push_back( std::make_unique< TFXY >( gateB ) ) ;
    vee.push_back( std::make_unique< TFXY >( gateC ) ) ;
...

  {
    ...
    TFXY gate1( 1 , 2 , a1 , b1 , c1 , d1 ) ;
    TFXY gate2( 0 , 1 , a2 , b2 , c2 , d2 ) ;
    TFXY gate3( 1 , 2 , a3 , b3 , c3 , d3 ) ;
    auto [ gateA , gateB , gateC ] = f3c::turnover( gate1 , gate2 , gate3 ) ;
    EXPECT_EQ( gateA.qubits()[0] , 0 ) ;
    EXPECT_EQ( gateA.qubits()[1] , 1 ) ;
    EXPECT_EQ( gateB.qubits()[0] , 1 ) ;
